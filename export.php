...
$PAGE->set_url('/grade/export/extended/export.php', array('id'=>$id));
...
$export = new grade_export_extended($course, $groupid, $formdata);
...
if (!empty($CFG->gradepublishing) && !empty($key)) {
    ...
    $event = \gradeexport_extended\event\grade_exported::create(array('context' => $context));
    $event->trigger();
    $export->print_grades();
}
