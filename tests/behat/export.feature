@gradeexport @gradeexport_extended
Feature: I need to export grades as extended
  In order to easily review marks
  As a teacher
  I need to have a export grades as extended
  ...
  Scenario: Export grades as text
    When I navigate to "Export > extended file" in the course gradebook
